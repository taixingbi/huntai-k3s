...
$KUBECTL -n ai-prod rollout status deployment/layer-mcp-github-v1 --timeout=120s 2>/dev/null || true
echo ""
...
$KUBECTL -n ai-prod get deploy,pods -l app=layer-mcp-github-v1 2>/dev/null || true
